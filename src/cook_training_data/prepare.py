...
2. Maps it to the score_response.v1.json schema
3. Generates synthetic evidence_quotes, errors, and suggestions using Azure OpenAI
4. Creates training/validation splits in JSONL format for fine-tuning
...
async def main():
    ...
    print(f"Successfully mapped {len(examples)} examples")
